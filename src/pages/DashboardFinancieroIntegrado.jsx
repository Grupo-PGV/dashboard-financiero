...
<div className="mb-6">
  <ChipaxEndpointDiscovery />
       ...
       // Buscar la sección de "Cuentas por Pagar" y reemplazar:
  ...
  <div className="space-y-3">
    {cuentasPorPagar.slice(0, 3).map(factura => (
      <div key={factura.id} className="border-b pb-2 last:border-b-0 last:pb-0">
        <div className="flex justify-between items-start">
          <div>
            {/* IMPORTANTE: Acceder a factura.proveedor.nombre, NO factura.proveedor directamente */}
...
// También hacer lo mismo para "Cuentas por Cobrar":
{/* Cuentas por Cobrar */}
<div className="bg-white shadow rounded-lg p-4">
  <div className="flex items-center justify-between mb-4">
    <div className="flex items-center">
  ...
  <div className="space-y-3">
    {cuentasPendientes.slice(0, 3).map(cuenta => (
      <div key={cuenta.id} className="border-b pb-2 last:border-b-0 last:pb-0">
        <div className="flex justify-between items-start">
          <div>
            {/* IMPORTANTE: cliente ya es un string según el adaptador */}
            <p className="font-medium text-gray-900">
