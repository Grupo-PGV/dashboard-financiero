              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-red-900">
                    Resumen Críticos - {periodos.find(p => p.valor === mesSeleccionado)?.etiqueta}
                  </h3>
                </div>
                      ...
                      return (
                        <tr key={nombre} className={index % 2 === 0 ? 'bg-white' : 'bg-red-25'}>
                          ...
                          <td className="px-3 py-2 text-sm">
                            {docsCompletados}/{todosDocumentos}
                          </td>
                          <td className="px-3 py-2">
                            <div className="flex items-center gap-2">
                                ...
                                {data.documentos.mensuales.map((documento, index) => {
                                  ...
                                  return (
                                    <div
                                      ...
                                      className={`p-3 rounded-lg border-2 cursor-pointer transition-all hover:shadow-sm ${
                                        completado 
                                          ? 'bg-green-50 border-green-200 hover:bg-greenimport React, { useState, useEffect } from 'react';
import { 
  FileCheck, 
  CheckCircle, 
  Circle, 
