...
import { Search, Eye, Calendar, FileText, AlertCircle, CheckCircle, Loader, Database } from 'lucide-react';

// ✅ ChipaxService integrado directamente para evitar dependencias externas
const chipaxService = {
  tokenCache: {
    token: null,
    expiry: null,
  ...
  async getChipaxToken() {
    const API_BASE_URL = 'https://api.chipax.com/v2';
    const APP_ID = '605e0aa5-c90f-4b58-8b34-f88b5b9e1f4b'; // Reemplaza con tu APP_ID
    const SECRET_KEY = 'tu_secret_key'; // Reemplaza con tu SECRET_KEY
